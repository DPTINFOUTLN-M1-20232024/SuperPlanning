...
DROP TABLE IF EXISTS SECRETARY_CONNECTION CASCADE;
CREATE TABLE SECRETARY_CONNECTION (
    ID              LONG AUTO_INCREMENT,
    MAIL            VARCHAR,
    HASH_PASSWORD   VARCHAR,
    CONSTRAINT SECRETARY_CONNECTION_PK PRIMARY KEY (ID),
    CONSTRAINT SECRETARY_CONNECTION_ID_UINDEX UNIQUE (ID)
);