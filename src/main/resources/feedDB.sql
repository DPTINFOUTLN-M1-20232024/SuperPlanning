...
INSERT INTO SESSION (BEGIN, FINISH, ID_MODULE, ID_INSTRUCTOR, ID_ROOM, SESSION_TYPE) VALUES
    ...
    ('2023-12-19 08:00:00', '2023-12-19 09:00:00', 1, 2, 2, 'TD'),
    ('2023-12-18 12:00:00', '2023-12-18 16:00:00', 1, 2, 2, 'TD');
...
INSERT INTO STUDENT_CONNECTION (ID_STUDENT, MAIL, HASH_PASSWORD) VALUES
    ...
    (4, 'a', '07123e1f482356c415f684407a3b8723e10b2cbbc0b8fcd6282c49d37c9c1abc');

INSERT INTO SECRETARY_CONNECTION (ID, MAIL, HASH_PASSWORD) VALUES
    (1, 'admin', '07123e1f482356c415f684407a3b8723e10b2cbbc0b8fcd6282c49d37c9c1abc');